document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        const response = await fetch('http://144.126.254.154:8085/api/registration-status');
    ...
    try {
        const response = await fetch('http://144.126.254.154:8085/api/problems');
...
async function handleSubmit(e) {
    ...
    try {
        const response = await fetch('http://144.126.254.154:8085/api/register', {
            method: 'POST',
            headers: {
